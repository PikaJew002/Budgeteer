...
<script>
  import { BModal, BAlert, BButton, BContainer } from 'bootstrap-vue';
  ...
  export default {
    ...
    computed: {
      ...
      goalContributions() {
        return this.goal.contributions.sort(function(a, b) {
          if(moment(a.start_on).isBefore(b.start_on, 'month')) {
            return -1;
          } else {
            return 1;
          }
